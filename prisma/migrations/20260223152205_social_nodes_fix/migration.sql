/*
  ...
  - The values [DISCORD,SLACK,TELEGRAM,WHATSAPP,TIKTOK] on the enum `CredentialType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CredentialType_new" AS ENUM ('OPENAI', 'GROK', 'ANTHROPIC', 'DEEPSEEK', 'PERPLEXITY', 'GEMINI');
...
ALTER TYPE "NodeType" ADD VALUE 'TIKTOK';
