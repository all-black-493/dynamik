                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            {isFetchingModels ? (
                                                <div className="flex items-center justify-center p-4 text-sm text-muted-foreground italic">
                                                    <span className="animate-pulse">Fetching Perplexity models...</span>
                                                </div>
                                    ...
                                    <FormDescription>
                                        The Perplexity Sonar model to use
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
